		...
		var tileObj = function (gx, gy) {
			...
			var solvedGx = gx,
				...
				var moveTiles=function (tile,animate) {
					...
					if (tile.gy === emptyGy){
						clickPos = tile.gx;
						dir = tile.gx < emptyGy ? 1: -1;
						for (x = emptyGy - dir; x !== clickPos - dir; x -= dir) {
				...
				var shuffle = function (){
					...
					if (Math.floor(Math.random() * 2)) {
						moveTiles(tilesArray[empytyGx][(empytyGy + 1 + randIndex) % numtiles], false);
					} else {
